...
const RegisterSupervisor = ({ onNavigate }) => {
  ...
  return (
    <div className="auth-container" style={{ background: 'linear-gradient(135deg, #1f0f0f 0%, #3d1a1a 30%, #5c2626 60%, #3d1a1a 100%)' }}>
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-group">
            ...
            <input type="text" name="company_name" value={formData.company_name} onChange={handleChange} required placeholder="Enter company name" />
          </div>

          <div className="form-group">
            <label>Designation <span className="required">*</span></label>
            <input type="text" name="designation" value={formData.designation} onChange={handleChange} required placeholder="e.g., Manager, Team Lead" />
          </div>
          ...
          <button type="submit" className="auth-button" disabled={loading}>
            {loading ? 'Registering...' : 'Register as Supervisor'}
          </button>
        </form>
