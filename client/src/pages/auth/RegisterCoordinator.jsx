...
const RegisterCoordinator = ({ onNavigate }) => {
  ...
  return (
    <div className="auth-container" style={{ background: 'linear-gradient(135deg, #2a1212 0%, #4d2020 30%, #6e3030 60%, #4d2020 100%)' }}>
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-group">
            ...
            <input type="text" name="employee_id" value={formData.employee_id} onChange={handleChange} required placeholder="e.g., MNHS-C-001" />
          </div>
          ...
          <div className="form-group">
            ...
            <input type="text" name="department" value={formData.department} onChange={handleChange} required placeholder="e.g., Work Immersion Department" />
          </div>
